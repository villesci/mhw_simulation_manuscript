...
We should check and make sure the CTmax and z estimates from our simulated data make sense (i.e. close to the values we used to simulate the data to begin with). 
