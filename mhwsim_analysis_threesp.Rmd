...
three_species<-ggplot()+
  ...
  annotate("text",x=29,y=5000,label=paste0("15 Days, \n" ,equ_res1b$tempatdeath,"°C "),
           size=4)+
  geom_point(aes(x=equ_res1b$tempatdeath,y=equ_res1b$timetodeath),shape=21,size=3,color="black",fill="white")+
  #chronic-mixed
  ...
  annotate("text",x=42.5,y=0.2,label=paste0("1 Minute,  \n",equ_res2$tempatdeath,"°C "),
           size=4)+
    geom_point(aes(x=equ_res2$tempatdeath,y=equ_res2$timetodeath),shape=21,color="black",,size=3,fill="white")+
  #acute-chronic
  ...
  annotate("text",x=37.5,y=9000,label=paste0(round((equ_res3$timetodeath/24),digits=1)," Hours, \n ",round(equ_res3$tempatdeath,digits=1),"°C "),
           size=4)+
      geom_point(aes(x=equ_res3$tempatdeath,y=equ_res3$timetodeath),shape=21,color="black",,size=3,fill="white")

three_species
ggsave(path = "result_figs",filename="threespecies_TDT.pdf", device='pdf', dpi=600,width=6,height=4,units="in")
...
ggsave(path = "result_figs",filename="species_heatmap_three.pdf", device='pdf', dpi=600,width=12,height=4,units="in")
...
ggsave(path = "result_figs",filename="species_combinedplots_three.tif", device='tiff', dpi=600,width=12,height=8,units="in")
...
ggsave(path = "result_figs/supp",filename="species_barchart.pdf", device='pdf', dpi=600,width=8,height=4,units="in")
...
#alpha_plot_combined
ggsave(path = "result_figs",filename="alpha_heatmap_three_concept.pdf", device='pdf', dpi=600,width=8,height=6,units="in")
...
ggsave(path = "result_figs",filename="timeseries_survprop.pdf", device='pdf', dpi=600,width=6,height=8,units="in")
...
ggsave(path = "result_figs/supp","seasonal_occ_barplot.pdf",device="pdf",width=12,height=8,units=c("in"),dpi=600) 
ggsave(path = "result_figs/supp","seasonal_occ_barplot.tif",device="tiff",width=12,height=8,units=c("in"),dpi=300)  
