---
title: "tdt_premise_extended_analysis"
...
ggplot(data = ext_bound, aes(x = duration, y = magnitude)) +
  ...
  theme_classic() +
  labs(x = "Duration (hours)", y = "Magnitude (°C)", fill = "Survival (%)") +
  ...
  scale_shape_manual(name = "TDT Curve Intersection",
                     ...
                     values = c(15, 17,16))+
  guides(color="none")+
  geom_point(data = points_data, aes(colour = colour, shape = intersection),size=2)
